...
const getOne = (req,res) =>{
   let article_id = parseInt(req.params.article_id);
    ...
    articles.getSingleArticle(article_id, (err,results) =>{
...
const updateArticle = (req,res) =>{
    ...
    articles.getSingleArticle(article_id, (err, result) =>{
        ...
        articles.updateArticle(article_id, result, (err, article_id) =>{
            if(err){
                console.log(err)
                return res.sendStatus(500)
            }
...
const deleteArticle = (req,res) =>{
    ...
    articles.getSingleArticle(article_id, (err, result) => {
        ...
        articles.deleteArticle(article_id, result, (err, article_id) =>{
            if(err) {
                return res.sendStatus(500);
            }
            return res.sendStatus(200);
